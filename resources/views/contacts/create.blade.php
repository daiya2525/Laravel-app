                            ...
                            <div class="container px-5 mx-auto">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="" class="leading-7 text-sm text-gray-600">性別</label><br/>
                                                <input type="radio" name="gender" id="gender" value="0">男性
                                                <input type="radio" name="gender" id="gender" value="1">女性
                                            </div>
                                        </div>
